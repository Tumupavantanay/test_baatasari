...
import {
  ...
  Eye, Star, Calendar, ShieldCheck, MapPin, GraduationCap, CheckCircle, Lightbulb, Zap
} from 'lucide-react';
    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="mx-3 mb-4 p-3.5 bg-white/5 border border-white/5 rounded-xl shadow-sm">
          ...
          <button className="flex items-center gap-1.5 text-[11px] font-bold text-[#D97706] hover:text-[#D97706]/80 transition-colors">
