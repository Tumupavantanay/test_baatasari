    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="flex items-center justify-between px-4 pt-4 pb-3.5 border-b border-border">
          <div className="flex items-center gap-2.5">
            ...
            <div className="leading-tight">
              ...
              <p className="text-[9px] text-muted-foreground font-medium tracking-widest uppercase">by BAATASARI</p>
            </div>
          </div>
          <button onClick={onClose} className="lg:hidden p-1 rounded-lg hover:bg-border">
                ...
                <li key={item.id}>
                  <Link href={item.href} onClick={onClose} aria-current={item.isActive ? 'page' : undefined}
                    className={cn(
                      ...
                      item.isActive ? 'bg-border text-foreground font-semibold' : 'text-muted-foreground hover:bg-border hover:text-foreground'
                    )}>
                    {item.isActive && <span className="absolute left-0 top-1/2 -translate-y-1/2 w-0.5 h-5 bg-primary rounded-r-full" />}
                    <Icon size={15} className={cn('flex-shrink-0', item.isActive ? 'text-primary' : 'text-muted-foreground group-hover:text-muted-foreground')} />
        ...
        <div className="mx-3 mb-4 p-3.5 bg-white border border-border rounded-xl shadow-sm">
          ...
          <button className="flex items-center gap-1.5 text-[11px] font-bold text-primary hover:text-foreground transition-colors">
